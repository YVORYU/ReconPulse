...
from pocsuite3.api import Output, POCBase, POC_CATEGORY, register_poc, requests, REVERSE_PAYLOAD, OptDict, VUL_TYPE, logger
...
class DemoPOC(POCBase):
    ...
    def _check(self, url):
        ...
        for payload in payloads:
            vul_url = url + payload
            try:
                r = requests.post(vul_url, data=data, timeout=10)
